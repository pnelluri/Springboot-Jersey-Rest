...
public class BasicRowMapper {
	...
	public Employee getEmployeesUsingCustomResultSetRowMapper(int id){  
	    String query="select * from Employee where id="+id;  
	    return jdbcTemplate.queryForObject(query,new MyRowMapper());  
	}
	public Employee getEmployeesUsingCustomResultSetRowMapper(int id,String name){  
	    String query="select * from Employee where id="+id;  
	...
	public Employee getEmployeesUsingCustomResultSetRowMapper(int id,String name,String role){  
	    String query="select * from Employee where id="+id;  
	    if(null !=name && !"".equals(name)) {
	    	query+=" and name like '"+name+"'";
	    }
